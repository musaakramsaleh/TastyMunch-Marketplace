...
const Footer = () => {
    return (
        <div className='bg-slate-900'>
           ...
           <div className=''>
           <Link to='/' className='text-yellow-400 text-xl   md:text-2xl  font-bold'><span className='text-red-600 font-lexend'>TastyMunch</span>Marketplace</Link>
         ...
         <p className='text-center text-white mt-3 pb-3 font-bold'>2024@TastyMunchMarketplace. All rights reserved</p>
        </div>
    );
};
